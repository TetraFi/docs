...
| ----------------------- | -------------------------------------------------------------------------------------------- |
| **Settlement engine**   | Atomic cross-chain execution; spread compression through solver competition and netting; depth aggregated from OTC desks, CEXs, DEXs, and regulated LPs |
