...
<Info>
  New here? Start with the **Discover** tab, from [Why TetraFi](/why-tetrafi): it gives the full picture of what is possible and where each primitive applies before you pick an API.
</Info>
