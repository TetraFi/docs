...
* **Atomic delivery-versus-payment.** Escrowed delivery-or-refund - assets and payment move together or not at all. Nothing has to be pre-funded to a venue and no principal is exposed while the other side decides.
