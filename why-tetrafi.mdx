...
<Info>
  **Start here.** The Discover tab is the full picture: what TetraFi is, how a trade moves through it, and where each primitive applies. Read it through before switching to the [Build](/build) tab for the APIs.
</Info>
