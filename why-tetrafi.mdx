...
The netting engine is the same. It only needs to know who owes whom and by when, so **one engine** clears invoices between companies, payment flows, loan repayments, and the obligations inside other settlement networks - all of which still pay in full today for amounts that cancel out. TetraFi's rails are just the first to use it - anyone can add it to what they already settle, and every book that joins nets more for everyone.
