...
* **Natively on-chain.** Every leg settles in immutable contracts rather than on a venue's internal ledger - so stablecoins, tokenized collateral, and DEX liquidity are **settlement legs**, not integrations.
