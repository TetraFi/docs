...
**Today** - **settlement and execution rails.** The live product suite: composable cross-chain liquidity aggregation, settlement, and execution with configurable policy enforcement - the rail everything below settles through. See [How TetraFi Works](/how-tetrafi-works).

**Next** - **the Shared Collateral Network.** Programmable collateral, committed once and cross-collateralised across the whole settlement stack - [T+0 redemption](/collateral/instant-redemption), [instant settlement](/collateral/instant-settlement), [venue prefunding](/collateral/venue-prefunding), [solver credit](/collateral/solver-credit) - one deep, fungible pool retiring the dead capital institutions strand in single-purpose buffers today. [Capital efficiency as infrastructure](/collateral).
