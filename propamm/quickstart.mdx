...
<Note>
  **Coming soon.** propAMM (RFS) is not yet live. This page documents the planned integration surface so you can evaluate the product ahead of launch - endpoints, contracts, and schemas may change before release.
</Note>
...
<Note>
  **Coming soon.** Guides on simulating swaps, same-block execution, and cross-pair routing, plus the full state schema and contract reference, will publish here as launch approaches.
</Note>
