...
<Note>
  Coming soon: [**TetraFi T+0 Vaults**](/vaults) add the instant-liquidity sleeve - curator-managed vault capital that services redemptions through the RFQ flow, so holders exit instantly even when the underlying settles T+1.
</Note>
