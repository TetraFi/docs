...
* **One record across the layers** (coming soon) - a settlement opted into [Multilateral Netting](/netting) keeps its trade record here and gains a per-run statement; see the [integration shape](/netting-api/introduction)
