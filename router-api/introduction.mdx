...
* **Direct DEX liquidity**, priced from on-chain market state
* **Programmable liquidity** - a maker quote and a DEX leg composed into one executable candidate (rolling out)
* **Composite routes** - multi-leg, with continuation and recovery when a leg parks
* **Tokenized-asset venues and fiat corridors** as legs (rolling out)
