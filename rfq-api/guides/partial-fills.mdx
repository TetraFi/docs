...
A partial fill lets your order settle for less than the full requested size when full liquidity isn't there at execution time. That's valuable when you're blending RFQ liquidity with other sources, or when conditions move and taking part of the size beats taking none of it.
