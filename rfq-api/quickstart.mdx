...
<Warning>
  **Never hardcode contract addresses.** Approval spenders and settler addresses come from the preflight `nextActions` for the quote you picked - they differ by chain and funding lock.

  For reference, on Optimism the escrow settlers currently are:

  * input settler (escrow): `0x2778258002a69a0cB1DfD29b360a0bB1654C8652`
  * compact settler (resource lock): `0x7dfFC9e7db5a96887666c1a6D215E5d3Fb306d69`
