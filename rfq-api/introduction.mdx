...
<Note>
  ...
  Planned (coming soon): a second firm quote per settlement - clear at a deadline you pick, at a tighter price - selected on the quote request. See the [Multilateral Netting integration shape](/netting-api/introduction).
</Note>
