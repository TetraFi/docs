...
You also pick the deadline - an hours-class tier or T+1 / T+2 - and a tier is no lock-in: need out early, a vault on the [Shared Collateral Network](/collateral) buys your position at its published discount.
...
<CardGroup cols={2}>
  ...
  <Card title="Shared Collateral Network" icon="vault" href="/collateral">
